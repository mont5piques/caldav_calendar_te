...
// Default calendar Save to
// $config['default_save_calendar'] = 'Personal';
...
$config['calendar_crypt_key'] = "GbdBs9nmq335q7qnP33HNfLk";
...
$config['calendar_oauth_providers'] = array(
    ...
    "key" => array(
        ...
        "json" => "/lib/vendor/oauth2/google_oauth.json"
//    ),
//
//    "key" => array(
...
// Caldav driver is supported only
 $config['calendar_preinstalled_calendars'] = array(
    'Nextcloud' => array(
                    ...
                    'caldav_user'  => '%u',
                    'caldav_pass'  => '%p',
                    'caldav_url'   => 'https://www.mint70.com/sandbox/cloud/remote.php/dav/calendars/%u/',
					'color' 	   =>  '',
                    'showAlarms'   => 1));
?>
